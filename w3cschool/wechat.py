...
# 处理收到的消息
@itchat.msg_register([TEXT, PICTURE, FRIENDS, CARD, MAP, ATTACHMENT, VIDEO], isFriendChat=True, isMpChat=True)
def handleRMsg(msg):
    global face_package
    # 接收消息的时间
    ...
    if msg['Type'] == 'Text' or msg['Type'] == 'Friends':
        ...
        print('[Text/Frinds]: {}'.format(msg_content))
    # 附件/视频/图片/语音
    ...
    if '撤回了一条消息' in msg['Content']:
        ...
        if len(recall_msg_id) < 11:
            ...
            msg_prime = '---' + recall_msg.get('msg_from') + '撤回了一条消息---\n' \
                        ...
                        '内容： ' + recall_msg.msg.get('msg_content')
